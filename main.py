...
class WebsiteMonitor:
    def __init__(self, url, interval=15):
        self.url = url
...
class GUI:
    def __init__(self, master):
        self.master = master
        self.monitor = WebsiteMonitor("http://127.0.0.1:8000/")
    ...
    def open_settings(self):
        ...
        self.url_entry.insert(0, self.monitor.url)
    ...
    def save_settings(self):
        self.monitor.url = self.url_entry.get()
